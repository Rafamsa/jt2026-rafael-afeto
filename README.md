...
[video](https://drive.google.com/drive/folders/1GePSUpBtj1R2QzdwTnCytBba7M6BjA8U?usp=sharing)
...
*Gráfico de Receita Média Anual por Perfil:*
![Receita Média Anual por Perfil](graficos/receita_media_anual.png)

*Quantidade de Anúncios por Perfil (Liquidez):*
![Quantidade de Anúncios por Perfil](graficos/tamanho_amostra.png)

**🗺️ Pergunta 2: Qual a melhor localização em termos de receita?**
...
*Mapa de Receita por Bairros:*
![Mapa de Receita por Bairros](graficos/mapa_receita_bairros.png)

**🛋️ Pergunta 3: Quais características explicam as melhores receitas?**
...
![Correlação de Fatores](graficos/correlacao_features.png)
